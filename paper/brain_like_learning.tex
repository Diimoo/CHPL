...
Our architecture (Figure~\ref{fig:architecture}) consists of three brain-inspired modules:
...
\begin{figure}[t]
    ...
    \fbox{\parbox{0.9\textwidth}{\centering
        \textit{[Figure 1: Architecture diagram showing Visual Cortex, Language Cortex, and ATL with shared prototypes. Include reconstruction pathway and Hebbian consolidation arrows.]}
    }}
    \caption{\textbf{Brain-inspired architecture for cross-modal learning.} Visual and language cortices extract modality-specific features, which are integrated in the Anterior Temporal Lobe (ATL) through competitive learning with shared concept prototypes. Predictive coding in visual cortex provides reconstruction-based learning signal.}
...
All code, data, and trained models are available at: \texttt{[GitHub repository URL]}.
