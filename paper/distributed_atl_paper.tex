...
\author{
    ...
    \textit{[Affiliations to be filled]}\\
    \texttt{[email]}
}
...
\textbf{Adult-Level Scaling (Phases 5-8):} Vocabulary scales from 50 to \textbf{290,133 words} (5,803$\times$ expansion via Wikipedia); visual grounding covers \textbf{28,489 words} from 118k COCO images; knowledge acquisition yields \textbf{1,985 patterns} from educational videos.
